...
2. Ограничить опцию generation 5+, multiplayer, human и более одного
   non-surrendered игрока.
3. Удалить standalone surrender UI/state/fetch из `PlayerHome.vue`.
4. Ограничить legacy surrender API тем же generation 5/active-turn контрактом
