...
foreach ($scriptPath in @($refreshScript, $deployScript, $releaseScript)) {
...
Write-Host "Step 1/3: Refresh clean release checkout"
...
Write-Host "Step 2/3: Deploy release checkout to staging"
...
Write-Host "Step 3/3: Promote tested staging artifact to prod"
