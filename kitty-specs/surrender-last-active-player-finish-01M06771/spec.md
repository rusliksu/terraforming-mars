...
- Commit `c3730fe1d` on `codex/tm-surrender-last-player-finish` implements the
  approved behavior on top of `22ac8145c`.
- Server suite: 7401 passing; client suite: 587 passing; focused final-surrender
